...
namespace Application.Utility.ClientLibrary.Collaboration
{
    ...
    {
        private const string _serviceHttp = "PAYMENTS_SERVICE_HTTP";
        private const string _serviceHttps = "PAYMENTS_SERVICE_HTTPS";

        public static async Task<bool> Transfer(this IClient factory, string authorizationToken,
            TransferData transfer)
        {
            ...
            var uri = $"{host}/api/payments/transfer";
